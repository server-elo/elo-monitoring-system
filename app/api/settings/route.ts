...
async function updateSettingsHandler(request: NextRequest) {
  ...
  try {
    ...
    // Update settings
    (_mockUserSettings as any)[section] = {
      ...(_mockUserSettings as any)[section] 
      ...validation.data
    };
    ...
    // Log settings update
    logger.info('Settings updated', { metadata: {
...
// Route handlers
export const GET = withErrorHandling(_getSettingsHandler);
export const PUT = withErrorHandling(_updateSettingsHandler);
