...
const fixes: [
  {
    ...
    patterns: [
      ...
      { find: /userId: string,/g, replace: 'userId: string,', description: 'Fix parameter comma spacing' },
      { find: /type: string,/g, replace: 'type: string,', description: 'Fix parameter comma spacing' },
    ]
  },
  {
