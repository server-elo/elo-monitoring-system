...
export const AICodeAnalyzer: React.FC<AICodeAnalyzerProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    'security' | 'gas' | 'quality' | 'complexity'
  >('security')
        ...
        securityIssues: [
          {
            ...
            message:
              'Potential reentrancy vulnerability detected in withdraw function',
            description:
          ...
          },
          {
            ...
            message:
              'Potential integer overflow detected in arithmetic operations',
        ...
        gasOptimizations: [
          {
            ...
            line: 8,
            suggestion:
              'Reorder struct variables to pack them more efficiently and reduce storage slots',
          },
          {
            ...
            line: 34,
            suggestion:
              'Cache array length in a variable before the loop to save gas',
          },
        ],
        codeQuality: {
          score: 78,
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400">
                  {analysisResult.gasOptimizations.reduce(
              ...
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getQualityColor(analysisResult.codeQuality.score)}`}
                >
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span
                                className={`text-lg font-bold ${getQualityColor(value as number)}`}
                              >
                                {value}%
                              </span>
                            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        {analysisResult.complexity.cyclomatic <= 10
                          ? 'Good'
                          : analysisResult.complexity.cyclomatic <= 20
                            ? 'Moderate'
                            : 'High'}
                      </p>
                    </div>
                    <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        {analysisResult.complexity.cognitive <= 15
                          ? 'Good'
                          : analysisResult.complexity.cognitive <= 25
                            ? 'Moderate'
                            : 'High'}
                      </p>
                    </div>
        ...
        <Card className="p-8 bg-white/10 backdrop-blur-md border border-white/20">
          <div className="text-center">
            ...
            <p className="text-gray-400">
              AI is examining security, gas efficiency, and code quality...
            </p>
          </div>
        </Card>
      )}
        ...
        <Card className="p-8 bg-white/10 backdrop-blur-md border border-white/20">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-4">
              Paste your Solidity code and click "Analyze Code" to get
