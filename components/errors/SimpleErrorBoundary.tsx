...
* Catches React errors and provides a clean fallback UI
*/
"use client";
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        ...
        className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">Refresh Page
        </button>
        <button
        onClick={() => window.history.back()}
        className="w-full px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors">Go Back
        </button>
        </div>
        {false /* client-side: no dev tools */ && this.state.error && (
