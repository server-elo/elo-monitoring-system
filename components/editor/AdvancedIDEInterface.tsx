      ...
      <div className="flex items-center justify-between border-b border-gray-800 bg-gray-900/95 px-4 py-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded p-1.5 text-gray-400 hover:bg-gray-800 hover:text-gray-300"
          >
            {currentTheme === 'dark' ? (
          ...
          <button
            ...
            className="flex items-center gap-1 rounded px-2 py-1 text-xs text-gray-400 hover:bg-gray-800 hover:text-gray-300"
          >
        ...
        <AnimatePresence>
          {layout.rightSidebar.visible && (
            <motion.div
              ...
              className="border-l border-gray-800 bg-gray-950"
            >
              <div className="p-4">
