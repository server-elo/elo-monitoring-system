...
export function AdvancedCollaborativeMonacoEditor({
  ...
  onContentChange,
  onCursorChange,
}: AdvancedCollaborativeMonacoEditorProps): React.ReactElement {
        ...
        <AnimatePresence>
          {showAnalysisPanel && analysisResults && (
            <motion.div
              ...
              className="absolute right-0 top-12 bottom-0 w-80 bg-gray-900/95 border-l border-gray-700 p-4 overflow-y-auto"
            >
