...
export function MobileOptimizedCodeEditor({
  ...
  const handleCodeChange = useCallback(
    (value: string | undefined) => {
      if (value !== undefined && value !== code) {
        ...
        // Update undo stack
        setUndoStack((prev: unknown) => [
          ...prev.slice(0, currentUndoIndex + 1),
          value,
        ])
  ...
  return (
    <div
      ref={containerRef}
      className={cn('flex flex-col h-full bg-gray-900 relative', className)}
    >
      {/* Header Toolbar */}
      ...
      <div className="flex items-center justify-around p-3 bg-gray-800 border-t border-gray-700">
        <Button
          ...
          className="flex-1 mx-1 text-white"
        >
          {isCompiling ? (
              ...
              {compilationResult.warnings.length > 0 && (
                <div className="space-y-2">
                  ...
                  {compilationResult.warnings.map((warning, index) => (
                    <Card
                      key={index}
                      className="p-3 bg-yellow-900/20 border-yellow-800"
                    >
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <Button
                ...
                variant="outline"
                onClick={() =>
                  setFontSize((prev: unknown) => Math.max(10, prev - 2))
                }
              >
                -
              </Button>
              ...
              <Button
                ...
                variant="outline"
                onClick={() =>
                  setFontSize((prev: unknown) => Math.min(24, prev + 2))
                }
              >
                +
              </Button>
        ...
        {showSnippets && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-0 top-0 bottom-0 w-80 max-w-[85%] bg-gray-800 z-50 shadow-xl"
            >
