...
This file provides comprehensive guidance to Claude Code when working with the Solidity Learning Platform - a Next.js 15 application with React 19, TypeScript, and AI-powered features for blockchain education.

## Project Overview

### Solidity Learning Platform
- **Purpose**: Next-generation platform for learning Solidity with AI tutoring, gamification, and real-time collaboration
- **Tech Stack**: Next.js 15, React 19, TypeScript, Prisma, PostgreSQL, Monaco Editor, Framer Motion
- **Key Features**: AI-powered tutoring, real-time collaboration, blockchain integration, achievement system, mobile-first design
- **Status**: Production-ready with ongoing mobile optimization and PWA enhancement
...
## 🚀 Using PRPs (Product Requirement Prompts)

### What is a PRP?
A PRP = PRD + curated codebase intelligence + agent/runbook. It provides everything needed to deliver production-ready code on the first pass.
...
### Creating PRPs for Solidity Platform Features
```bash
# Example: Create PRP for a new feature
/prp-base-create implement advanced gas optimization analyzer

# Example: Create TypeScript-specific PRP
/TS-create-base-prp add real-time collaboration cursor tracking
```

### PRP Location & Structure
- **Active PRPs**: `/PRPs/*.md`
- **Templates**: `/PRPs/templates/`
- **Completed**: `/PRPs/completed/`

### Example PRP Usage
1. **Create PRP**: `/prp-base-create [feature description]`
2. **Review & Refine**: Edit the generated PRP in `/PRPs/`
3. **Execute**: `/prp-base-execute PRPs/[feature].md`
4. **Validate**: Run all validation commands in the PRP

### Project-Specific PRPs Available
- `swipe-navigation-lessons.md` - Touch gesture navigation implementation

### When to Use PRPs
- **New Features**: Any feature requiring 3+ files or complex logic
- **Refactoring**: Major architectural changes
- **Integration**: External service or library integration
- **Performance**: Optimization requiring systematic approach

### Programmatic PRP Usage

I can now execute PRPs programmatically using the TypeScript PRP library:

```typescript
// Automatically create and execute PRPs
import { implementFeature, prp } from '@/lib/prp';

// Quick implementation
const result = await implementFeature('add dark mode toggle');

// Or step by step
const prpFile = await prp.create({ feature: 'implement OAuth' });
const result = await prp.execute(prpFile);
```

When you ask me to implement complex features, I will:
1. Check if the task should use a PRP (using `PRP_TRIGGERS.shouldUsePRP()`)
2. Create a comprehensive PRP with research
3. Execute the implementation following the blueprint
4. Run all validation gates
5. Ensure production-ready code on first pass

---

*This guide is optimized for Next.js 15 with React 19 and the Solidity Learning Platform.*
*Focus on type safety, performance, accessibility, and mobile-first development.*
